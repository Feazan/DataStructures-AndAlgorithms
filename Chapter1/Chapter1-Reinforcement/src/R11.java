...
public class R11
{
     ...
     */
    public R11(String cust, String bk, String acnt, int lim, double initialBal)
    {
        customer = cust;
        bank = bk;
        account = acnt;
     ...
     * @param lim     the credit limit (measured in dollars)
     */
    public R11(String cust, String bk, String acnt, int lim) {
    ...
    public static void printSummary(R11 card) {
    ...
    public static void main(String[] args) {
        R11[] wallet = new R11[3];
        wallet[0] = new R11("John Bowman", "California Savings",
                "5391 0375 9387 5309", 5000);
        wallet[1] = new R11("John Bowman", "California Federal",
                "3485 0399 3395 1954", 3500);
        wallet[2] = new R11("John Bowman", "California Finance",
                "5391 0375 9387 5309", 2500, 300);

        for (int val = 1; val <= 16; val++) {
            wallet[0].charge(3*val);
            wallet[1].charge(2*val);
            wallet[2].charge(25*val);
        }

        for (R11 card : wallet) {
            R11.printSummary(card);        // calling static method
